  ...
  return (
    <div className={`${DEFAULT_CLASSNAME}`}>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="Купить Мобильные телефоны, Аксессуары, Электронную технику Минск"
        />
      ...
      <h1 align={'center'}>{'Dreamstore. Лучший способ приобрести желанную технику.'}</h1>
      <div className={`${DEFAULT_CLASSNAME}_title`}>
        Последние новинки. <span>Узнайте, что нового у нас сейчас.</span>
      </div>
      ...
      <div className={`${DEFAULT_CLASSNAME}_services`} onClick={() => navigate('/services')}>
        <img loading={'lazy'} src={servicesBanner} alt={'main_services'} />
      </div>
    </div>
  );
};
